...
(function() {
  ...
  goog.provide('gn_search_inspireportal_config');

  var module = angular.module('gn_search_inspireportal_config', []);

  module.value('gnTplResultlistLinksbtn',
      '../../catalog/views/inspireportal/directives/partials/linksbtn.html');
