...
const mr2020_data_dir = 'mr2021/march/resources';

const file_folder_geoportal = 'geoportal';
const file_folder_validator = 'validator';

// Spreadsheet informations
const spreadsheet_title = 'Monitoring Indicators 2021 - March';
const spreadsheet_subject = 'Monitoring Indicators 2021 - March';
...
const starRating_htmlSnippetTemplate = '<div title="{srTooltipTitle}" data-toggle="tooltip" data-placement="up">{srStarsContent}</div>';
...
<div class="card mb-4 bg-light text-dark" id="card-{cCode}" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Click for more details">
    <a href="mr2021_march_details.html?country={cCode}" class="h-100 nounderline text-dark">
...
<!--
                                <h6 class="font-weight-normal dataset_failed_link_container float-right mb-0"><a class="dataset_failed_link" href="mr2021/march/resources/failed_report/{0}.dataset.zip"><i class="far fa-file-archive"></i> Click to download the test reports of failed records</a></h6>
-->
                            </div>
                        </div>
                        <div class="card">
...
<!--
                                <h6 class="font-weight-normal services_failed_link_container float-right mb-0"><a class="services_failed_link" href="mr2021/march/resources/failed_report/{0}.services.zip"><i class="far fa-file-archive"></i> Click to download the test reports of failed records</a></h6>
-->
                            </div>
                        </div>
                    </div>
<!--
                    <h5 class="font-weight-normal failed_csv_container">
                        Summary of metadata failing validation in <a class="failed_csv" href="mr2021/march/resources/failed/{0}.failed.csv">this endpoint <i class="fas fa-file-csv"></i></a> (batch file identifier, metadata identifier, metadata type, total number and ids of failed test assertions)
                    </h5>
                    <h5 class="font-weight-normal">
                        Summary of metadata failing validation in <a href="mr2021/march/resources/MetadataFailingValidationAllEndpoints.xlsx">all endpoints <i class="fas fa-file-excel"></i></a> (see "readme" sheet for details)
                    </h5>
-->
                </div>
            </div>
        ...
        <div class="row mt-5 mb-2">
            <div class="col-md-10 offset-md-1 text-center">
                <div class="page-header text-center">
                    <h2>Monitoring Indicators 2021 - March <a href="" title="For the description of all indicators see bellow the section 'Documentation'" data-toggle="tooltip" data-placement="top"><i class="fas fa-link"></i></a></h2>
                </div>
            </div>
        </div>
        <div class="row">
